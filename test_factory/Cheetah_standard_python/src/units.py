...
class UNITS_class:
    def __init__(self):
        ...
        self.pc = (648000.0 / np.pi) * self.astro_unit
        ...
        self.uG = 1e-6 * self.G
        self.kG = 1e3 * self.G
        self.Oe = (1000.0 / (4.0 * np.pi)) * self.A / self.m
        ...
        self.ARichardson = (
            4.0 * np.pi * self.e * self.me * self.kB**2
        ) / self.hPlanck**3
